        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body ">
                    ...
                    <div class="layui-card-body layui-table-body layui-table-main" id="houseTenantItem">
...
<script>
    ...
    function itemDel(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            $.post("/houseTenant/delete", {"id": id}, function (response) {
    ...
    $(document).ready(function () {
        $.post("/houseTenant/items", function (resonse) {
